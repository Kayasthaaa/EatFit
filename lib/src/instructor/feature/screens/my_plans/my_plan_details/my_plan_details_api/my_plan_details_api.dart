...
class GetPlansDetailsApi {
  static final Dio _dio = Dio(BaseOptions(baseUrl: ApiUrl.kApiBaseUrl));

  static Future<GetPlansModels> getPlansDetails(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        GetPlansModels data = GetPlansModels.fromJson(response.data);
        return data;
      } else if (response.statusCode == 401) {
        await RefreshTokenService.refreshAccessToken();
        return await getPlansDetails(id: id, cancelToken: cancelToken);
      } else {
